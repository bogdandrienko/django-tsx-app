...
#                 'value': 'text',  # Начальное значение поля (Второстепенное по приоритету после "initial")
...
#                 'value': 'much_text',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#
#                 'minlength': '10',
#                 'maxlength': '200',
...
#                 'value': 'password_text',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#
#                 'minlength': '10',
#                 'maxlength': '20',
...
#                 'value': 'bogdandrienko@gmail.com',  # Начальное значение поля (Второстепенное по приоритету после
#                 # "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#             }
#         ),
...
#                 # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#             }
#         ),
#     )
...
#                 'value': '0',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#
#                 'min': '10',
#                 'max': '20',
...
#                 'value': 'hidden',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#             }
#         ),
#     )
...
#                 'value': 'checkbox',  # Начальное значение поля (Второстепенное по приоритету после "initial")
...
#                 'value': 'checkbox_null',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#             }
#         ),
#     )
...
#                 'value': 'MARCH',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#             },
...
#                 'value': 'file',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#
...
#                 'value': 'clearablefile',  # Начальное значение поля (Второстепенное по приоритету после "initial")
#                 'class': 'form-control',  # HTML / css / bootstrap классы
#
