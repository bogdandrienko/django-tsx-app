...
export default function Page(): JSX.Element {
  ...
  async function GetMonitoringData() {
    try {
      const config = {
        url: `api/reports/time_wait_to_load/?date=${getterFormObj.dateFrom}&shift=${getterFormObj.shiftFrom}&selectTechId=${getterFormObj.selectTechId}&target=${getterFormObj.target}`,
        method: `GET`,
        timeout: 30000,
        headers: {
          Authorization: `;`,
