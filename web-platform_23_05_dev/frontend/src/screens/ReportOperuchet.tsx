...
export default function Page(): JSX.Element {
  ...
  async function GetMonitoringData() {
    try {
      const config = {
        url:
          `reports/operuchet/dumptrucks/?dateFrom=${getterFormObj.dateFrom}&shiftFrom=${getterFormObj.shiftFrom}` +
  ...
  return (
    <base.Base1
      title={"Отчёты: Оперучёт производительности автосамосвалов"}
      description={
        "на этой странице можно выгрузить оперативный учёт по производительности автосамосвалов"
      }
    >
