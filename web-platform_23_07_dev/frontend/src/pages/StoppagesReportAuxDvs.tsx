...
export default function Page(): JSX.Element {
  ...
  const sliceStoppagesReportAuxDvsStore =
    slices.stoppages.stoppagesReportAuxDvsStore;
  const stoppagesReportAuxDvsStore = hooks.useSelectorCustom1(
    sliceStoppagesReportAuxDvsStore
  );
  ...
  useEffect(() => {
    if (stoppagesReportAuxDvsStore.data) {
      setMonitoring(stoppagesReportAuxDvsStore.data);
    }
  }, [stoppagesReportAuxDvsStore.data]);
  ...
  async function GetData() {
    if (getterFormObj.paramDate !== "") {
      dispatch(
        sliceStoppagesReportAuxDvsStore.action({
          form: { ...getterFormObj },
        })
      );
    } else {
  ...
  return (
    ...
    >
        ...
        <div className={"input-group w-100 m-1 p-2"}>
          ...
          <button
            ...
            className={
              ...
              stoppagesReportAuxDvsStore.load === true
      ...
      <div className={"card text-bg-light m-0 p-0 pt-1"}>
        {(stoppagesReportAuxDvsStore.fail ||
          stoppagesReportAuxDvsStore.error) && (
        ...
        >
          ...
          <div className={"w-25"}>
            <components.StatusStore1
              slice={sliceStoppagesReportAuxDvsStore}
      ...
      <div className="card text-bg-light m-0 p-0">
        {(stoppagesReportAuxDvsStore.fail === undefined ||
          stoppagesReportAuxDvsStore.error === undefined) &&
        monitoring &&
        monitoring.data ? (
          <components.Accordion2
            isCollapse={false}
