...
export default function Page(): JSX.Element {
  ...
  async function GetMonitoringData() {
    ...
    const config = {
      url: `${constants.SERVER_HOST_AND_PORT_CONSTANT}shovels/eventstate/`,
      method: `GET`,
      timeout: 5000,
      headers: {
  ...
  return (
    <base.Base1
      title={"Показатели: Экскаваторы"}
      description={"Сообщения с экскаваторов (скорость, время, координаты)"}
    >
