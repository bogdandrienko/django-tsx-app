...
export default function Page(): JSX.Element {
  ...
  const userLoginStore = hooks.useSelectorCustom1(slices.old.userLoginStore);
  ...
  function Login(event) {
    ...
    if (captchaCheckStore.data) {
      dispatch(slices.old.userLoginStore.action({ form: { ...user } }));
    }
  }
          ...
          <div className="card shadow custom-background-transparent-low m-0 p-0">
              ...
              <div className="m-0 p-1">
                <label className="form-control-sm text-center w-75 m-0 p-1">
                  ...
                  <small className="custom-color-warning-1 m-0 p-0">
                    * только числа, латиница и нижний пробел
            ...
            <div className="card-footer m-0 p-0">
              <components.StatusStore1
                slice={slices.old.userLoginStore}
