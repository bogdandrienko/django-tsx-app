...
export const speed = {
  ...
  speedReportDumptrucksCustomStore: utils.ConstructorSlice1(
    "speedReportDumptrucksCustomStore",
    ConnectReducer1,
    function ({ ...args }) {
      return async function (dispatch: Dispatch<any>) {
        dispatch(
          utils.ConstructorAction1(
            { ...args.form },
            `${constants.SERVER_HOST_AND_PORT_CONSTANT}speed/report/dumptrucks_custom`,
            constants.HttpMethods.GET(),
            300000,
            utils.ConstantConstructor1("speedReportDumptrucksCustomStore"),
            false
          )
        );
      };
...
export const pto = {
  ...
  ptoMonitoringStickingStore: utils.ConstructorSlice1(
    "ptoMonitoringStickingStore",
    ConnectReducer1,
    function ({ ...args }) {
      return async function (dispatch: Dispatch<any>) {
        dispatch(
          utils.ConstructorAction1(
            { ...args.form },
            `${constants.SERVER_HOST_AND_PORT_CONSTANT}pto/monitoring/sticking`,
            constants.HttpMethods.GET(),
            30000,
            utils.ConstantConstructor1("ptoMonitoringStickingStore"),
            false
          )
        );
      };
