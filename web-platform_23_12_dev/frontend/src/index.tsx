...
import SpeedReportDumptrucksCustom from "./pages/SpeedReportDumptrucksCustom";
...
import PtoMonitoringSticking from "./pages/PtoMonitoringSticking";
    ...
    <BrowserRouter>
      {constants.IS_CENTR_MONITORING ? (
        ...
        <Routes>
          ...
          ></Route>
          <Route
            path="/pto/monitoring/sticking"
            element={<PtoMonitoringSticking />}
          ></Route>
          {/* TODO pto /////////////////////////////////////////////////////// */}
