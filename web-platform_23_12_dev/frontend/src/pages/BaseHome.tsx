              ...
              <div className="card shadow-sm">
                <div className="d-flex flex-column align-items-stretch flex-shrink-0 bg-white">
                  ...
                  <div className="list-group list-group-flush">
                    ...
                    <Link
                      to={"/pto/monitoring/sticking"}
                      className="list-group-item list-group-item-action bg-primary-custom-1 text-white py-3 lh-tight"
                      aria-current="true"
                    >
                      <div className="d-flex w-100 align-items-center justify-content-between">
                        <strong className="mb-1">
                          Мониторинг налипаний/намерзаний
                        </strong>
                      </div>
                      <div className="small">
                        Мониторинг в реальном времени по налипаниям/намерзаниям
                      </div>
                    </Link>
                  </div>
                </div>
            ...
            <div className="col">
              <div className="card shadow-sm">
                <div className="d-flex flex-column align-items-stretch flex-shrink-0 bg-white">
                  ...
                  <div className="list-group list-group-flush">
                    <Link
                      to={"/speed/report/dumptrucks_custom"}
                      className="list-group-item list-group-item-action lh-tight p-3 bg-warning-custom-1 text-dark"
                      aria-current="true"
                    >
                      <div className="d-flex w-100 align-items-center justify-content-between">
                        <strong className="mb-1">
                          Отчёт по технической и эксплуатационной средней
                          скорости автосамосвалов
                        </strong>
                      </div>
                      <div className="small">
                        Отчёт по технической и эксплуатационной средней скорости
                        автосамосвалов
                      </div>
                    </Link>
                  </div>
