...
export default function Page(): JSX.Element {
  ...
  const slice = slices.speed.speedReportDumptrucksCustomStore;
  ...
  return (
    <base.Base2
      title={
        "СКОРОСТЬ АВТОСАМОСВАЛОВ: Отчёт по технической и эксплуатационной средней скорости автосамосвалов"
      }
      description={
