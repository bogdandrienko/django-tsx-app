  ...
  switch (action.type) {
    ...
    case "ERROR_FRONTEND_CAPTCHA": {
      return {
        load: false,
        data: undefined,
        error: "Произошла ошибка (frontend)",
      };
    }
    case "ERROR_BACKEND_CAPTCHA": {
      return {
        load: false,
        data: undefined,
        error: "Произошла ошибка (backend)",
      };
    }
    case "RESET_CAPTCHA": {
...
//     slices.old.captchaCheckStore
//   );
//
//   async function Check2(event: MouseEvent<HTMLDivElement>) {
//     dispatch(slices.old.captchaCheckStore.action({ form: { id: 666 } }));
//   }
//
//   useEffect(() => {
...
//       utils.Delay(
//         () => dispatch({ type: slices.old.captchaCheckStore.constant.reset }),
//         60000
//       );
//     }
...
//         slice={slices.old.captchaCheckStore}
