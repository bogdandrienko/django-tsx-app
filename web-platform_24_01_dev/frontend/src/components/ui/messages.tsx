  ...
  static Success({ children }) {
    ...
    return (
      ...
      >
        ...
        >
          <div className={"card-header bg-success lead text-white m-0 p-1"}>
            успешно
          </div>
  ...
  static Danger({ children }) {
    ...
    return (
      ...
      >
        ...
        >
          <div className={"card-header bg-danger lead text-white m-0 p-1"}>
            внимание!
          </div>
  ...
  static Warning({ children }) {
    ...
    return (
      ...
      >
        ...
        >
          <div className={"card-header bg-warning lead text-white m-0 p-1"}>
            внимание!
          </div>
  ...
  static Secondary({ children }) {
    ...
    return (
      ...
      >
        ...
        >
          <div className={"card-header bg-secondary lead text-white m-0 p-1"}>
            информация
          </div>
